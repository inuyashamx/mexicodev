...
bp "Automake 1.17" "automake-1.17.tar.xz" ""
...
bp "Gawk 5.3.1" "gawk-5.3.1.tar.xz" ""
...
bp "Man-DB 2.12.1" "man-db-2.12.1.tar.xz" "--sysconfdir=/etc --disable-setuid --enable-cache-owner=bin --with-browser=/usr/bin/lynx --with-vgrind=/usr/bin/vgrind --with-grap=/usr/bin/grap"

echo "=== Bash 5.2.32 final ==="
